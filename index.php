        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) { // Mengambil setiap baris data kegiatan
                    ...
                    echo "</td>";
                    echo "<td>
                            <a href='index.php?action=edit&id=" . $row['id'] . "' class='btn btn-info btn-sm'>Edit</a> <!-- Tombol Edit -->
                            <a href='index.php?action=delete&id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Hapus</a> <!-- Tombol Hapus -->
                          </td>";
                    echo "</tr>";
                }
                ?>
